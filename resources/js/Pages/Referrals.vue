<template>
  <div class="py-2 bg-gray-900 text-gray-200 min-h-screen">
      ...
      <div class="bg-gray-800 shadow-xl rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div class="bg-gray-700 p-4 rounded-lg shadow">
            <h2 class="text-xl font-bold mb-4">Referrers Leaderboard</h2>
            <ul>
              <li
...
export default {
  ...
  methods: {
    async getReferrals() {
      try {
        const response = await axios.get(`/api/ref-list/${this.id}`);
