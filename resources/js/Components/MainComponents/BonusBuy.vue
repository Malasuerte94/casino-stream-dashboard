    ...
    <div>
        <div>
            ...
            <template v-if="bonusBuyGames">
                ...
                <div v-for="(game, index) in bonusBuyGames" :key="index"
                ...
                <div class="flex mt-8 center justify-center">
                    <button @click="createNewBonusBuyGameRow" type="button"
...
export default {
    ...
    methods: {
        ...
        async updateBonusBuy() {
            ...
            await axios.patch('/api/bonus-buy', {
                bonusBuy,
            })
                .then(function (response) {
                    console.log(response);
        ...
        calcCurentRowMultiplier(game, index) {
            if (game.name == '' || game.stake == '' || game.price == '' || game.result == '') {
                return
            }
            this.bonusBuyGames[index].multiplier = Math.round(game.result / game.stake, 2)
        },
    }
}
</script>