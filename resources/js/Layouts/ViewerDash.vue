      ...
      <nav class="bg-gray-800/30 border-b border-gray-700 backdrop-blur-md shadow-lg">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <NavLink :href="route('streamer-list')" :active="route().current('streamer-list')">
                  Streamers
                </NavLink>
              </div>
              <div v-if="$page.props.user_streamer" class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <NavLink :href="route('streamdash')">
                  Schimbă pe Streamer
                </NavLink>
              </div>
            </div>
        ...
        <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
          <div class="pt-2 pb-3 space-y-1">
            <ResponsiveNavLink :href="route('streamdash')" :active="route().current('streamdash')">
              Dashboard
            </ResponsiveNavLink>
          </div>
